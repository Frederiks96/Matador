...
public interface Ownable {
	 ...
	 * 
	 * @return true if the field os owned, otherwise returns null
	 */
	boolean isOwned();
	
	/**
	 * Sets player as the owner of the field in the game logic and the GUI, if the owner has enough credit to buy. 
	 * Subtracts the price of the field from the players account, otherwise prints a message to the user that he has insufficient funds.
	 * 
	...
	/**
	 * Mortgages a field, and updates the players balance with the value of the mortgage 
	 * 
	 * @param text – The text object that specifies which text will be shown to the user, depending on the language
	...
	/**
	 * Cancels the mortgage of a field and subtracts the value of the mortgage and an interest of 10% from the players account.
	 */
	void unMortgage();
