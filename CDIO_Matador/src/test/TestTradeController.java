...
public class TestTradeController {
	...
	public void testNoProperties() {
		...
		assertEquals(board.getOwner(1),player1);
		assertEquals(board.getOwner(3),player2);
		assertEquals(board.getOwner(6),player1);
		assertEquals(board.getOwner(8),player1);
		assertEquals(board.getOwner(9),player1);
		assertEquals(4,player1.getNumTerritoriesOwned());
