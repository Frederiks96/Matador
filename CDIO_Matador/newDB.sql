...
delimiter //
CREATE PROCEDURE money_transfer (in field_id_in int, player_id_in int, in owner_id_in int, player_balance_in int, in owner_balance_in int) begin start transaction;
