...
drop procedure pay_rent;

delimiter //
CREATE PROCEDURE pay_rent (in field_id_in int, player_id_in int, in owner_id_in int, player_balance_in int, in owner_balance_in int) begin start transaction;
